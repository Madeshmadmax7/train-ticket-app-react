...
const TrainTicket = () => {
    ...
    const { departureDate, selectedSeats } = state || {};
    ...
    const handlePrint = () => {
        const ticketDetails = `Train No: ${trainNumber}, Date: ${departureDate}, Seats: ${selectedSeats?.join(', ')}, Platform: ${platformNumber}, Departure Time: ${departureTime}`;
                ...
                <div className="ticket">
                    ...
                    <div className="ticket-info">
                        ...
                        <div className="ticket-details">
                            <p><strong>NO:</strong> {trainNumber}</p>
